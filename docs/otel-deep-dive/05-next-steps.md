...
- **Synthetics** (item 1) — deliberately *not* in this pack: synthetics is an outside-in signal ([parent guide, concept 7](../03-how.md)) that OTel doesn't produce; it's a consumer-side concern (Grafana Synthetic Monitoring, Elastic Synthetics, Checkly...). Worth its own short study.
...
⬅ Back to [00-overview.md](00-overview.md) · ⬆ Up to the [parent observability guide](../00-overview.md)
